      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column prop="img" label="图片">
          <template #default="scope">
            <el-image  v-if="scope.img" :src="scope.row.img" :preview-src-list="[scope.row.img]" preview-teleported style="width: 40px; height: 40px"></el-image>
          </template>
        ...
        <el-table-column prop="categoryName" label="分类ID"></el-table-column>
    ...
    <el-dialog title="商品信息" width="50%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px" style="padding-right: 30px; padding-top: 20px">
        ...
        <el-form-item prop="description" label="简介">
          <el-input v-model="data.form.description" placeholder="请输入简介"></el-input>
        </el-form-item>
        ...
        <el-form-item prop="status" label="上架状态">
          <el-input v-model="data.form.status" placeholder="请输入上架状态"></el-input>
          <el-radio-group  v-model="data.form.status"></el-radio-group>
